...
class ColorManager {
  ...
  static Color secondary = HexColor.fromHex('#ff563d'); //* update
  static Color lightSecondary = HexColor.fromHex('#ff7d3d'); //* update
  ...
  static Color background = HexColor.fromHex('#eef7fb');
}
