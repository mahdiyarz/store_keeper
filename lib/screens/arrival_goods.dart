...
class _ArrivalGoodsState extends State<ArrivalGoods> {
  ...
  void _showModalBottomSheet(
      BuildContext context, double width, List<BrandsModel> brands) {
    var showBrandName;
                  ...
                  ElevatedButton(
                    ...
                    onPressed: () {
                      showDialog(
                        ...
                        if (returnValue != null) {
                          brandNameController.text = returnValue.toString()[
                              1]; //? Pass brand id to out controller
                          setState(() {
                            showBrandName =
  ...
  Widget build(BuildContext context) {
    ...
    List<BrandsModel> brands =
        Provider.of<BrandsProvider>(context, listen: false).brandsItems;
    ...
    return ScreensStyle(
      ...
      bottomWidget: ElevatedButton.icon(
        onPressed: () {
          _showModalBottomSheet(context, width, brands);
          brandNameController.text = '';
          boxNumberController.text = '';
        },
